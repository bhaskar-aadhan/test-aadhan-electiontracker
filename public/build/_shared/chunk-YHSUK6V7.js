...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701579888591.7354";
}
...
var ConstituencyProvider = ({
  ...
  (0, import_react.useEffect)(() => {
    ...
    const initializeWebSocket = () => {
      const socket = new WebSocket("wss://cmsapis.aadhan.in/election-results/ws23");
      socket.onopen = () => {
    ...
    const initializeWebSocket2 = () => {
      const socket2 = new WebSocket("wss://cmsapis.aadhan.in/election-results/ws13");
      socket2.onopen = () => {
...
//# sourceMappingURL=/build/_shared/chunk-YHSUK6V7.js.map
