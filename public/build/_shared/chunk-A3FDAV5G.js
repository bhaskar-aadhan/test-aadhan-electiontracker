...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701509899054.5867";
}
...
var getRoundNo = (data, stateName, constituency) => {
  ...
  const lastKey = constituenciesData?.[0]?.["candidates"]?.map((candidate) => {
    ...
    const lastKey2 = keys.length > 0 ? keys[keys.length - 1] : 0;
    return lastKey2;
  });
  return lastKey[0];
};
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701341745908.4128";
}
function cn(...inputs) {
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701176092140.0122";
}
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701175484660.016";
}
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/components/ui/table.jsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701414507765.664";
}
...
//# sourceMappingURL=/build/_shared/chunk-A3FDAV5G.js.map
