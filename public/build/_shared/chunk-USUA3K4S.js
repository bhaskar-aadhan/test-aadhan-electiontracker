...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701575386001.7163";
}
...
var getConstituenciesData = (data, stateName, constituency) => {
  ...
  constituenciesData.forEach((stat) => {
    ...
    const addedData = sortedData.map((candidate, index2, array) => ({ ...candidate, status: index2 === 0 && array[0]["total_votes"] > 0 ? "Leading" : "Trailing", differData: index2 === 0 ? candidate["total_votes"] - array[1]["total_votes"] : 0, color: index2 === 0 && array[0]["total_votes"] > 0 ? "#00B929" : "#FF8300" }));
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701575385989.1794";
}
function cn(...inputs) {
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701575385988.1726";
}
...
//# sourceMappingURL=/build/_shared/chunk-USUA3K4S.js.map
